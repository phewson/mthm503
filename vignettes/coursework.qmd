...
Analyse the effect of **casualty age and sex** on the **method of extrication** used by the fire brigade.
...
- Build a suitable regression model (e.g., generalised linear model, generalised addtive model)
...
You must:
- Fork the provided GitHub template repository
